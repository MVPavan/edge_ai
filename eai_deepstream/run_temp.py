...
pipeline_design_path = "ds_configs/pipeline_configs/pipeline_design/od_pipeline_concurrent.yml"
pipeline_properties_path = "ds_configs/pipeline_configs/pipeline_props/od_props_concurrent.yaml"
